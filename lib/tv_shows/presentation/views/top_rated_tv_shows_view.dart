    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return DecoratedBox(
          ...
          child: Column(
            children: [
              // const HybridNativeAdWidget(adKey: 'top_rated_tv_shows'),
              _HeaderBanner(count: tvShows.length, width: width),
              Expanded(
                child: wide
                    ? _WideTopRatedGrid(tvShows: tvShows, width: width)
                    : _MobileTopRatedList(tvShows: tvShows),
              ),
            ],
          ),
        );
...
/// ---------------------------------------------------------------------
class _MobileTopRatedList extends StatelessWidget {
  const _MobileTopRatedList({required this.tvShows});
...
/// ---------------------------------------------------------------------
class _WideTopRatedGrid extends StatefulWidget {
  const _WideTopRatedGrid({required this.tvShows, required this.width});

  final List<Media> tvShows;
  final double width;

  @override
  State<_WideTopRatedGrid> createState() => _WideTopRatedGridState();
}

class _WideTopRatedGridState extends State<_WideTopRatedGrid> {
  ...
  @override
  void didUpdateWidget(covariant _WideTopRatedGrid oldWidget) {
