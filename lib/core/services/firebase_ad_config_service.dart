...
class FirebaseAdConfigService {
  ...
  void _loadAdKeys() {
    _adKeys = {
      'banner-1-468x60': _remoteConfig!.getString('ad_key_banner_1_468x60'),
      'banner-728x90': _remoteConfig!.getString('ad_key_banner_728x90'),
      'banner-2-300x250': _remoteConfig!.getString('ad_key_banner_2_300x250'),
      'banner-3-160x600': _remoteConfig!.getString('ad_key_banner_3_160x600'),
      'banner-4-160x300': _remoteConfig!.getString('ad_key_banner_4_160x300'),
      'banner-5-320x50': _remoteConfig!.getString('ad_key_banner_5_320x50'),
      'banner-6-728x90': _remoteConfig!.getString('ad_key_banner_6_728x90'),
      'ad-sidebar-left-160x600': _remoteConfig!.getString('ad_key_sidebar_left_160x600'),
      'ad-sidebar-right-160x600': _remoteConfig!.getString('ad_key_sidebar_right_160x600'),
      'ad-bottom-468x60': _remoteConfig!.getString('ad_key_bottom_468x60'),
    };
  }
